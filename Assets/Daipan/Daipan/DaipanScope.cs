...

{
    public sealed class DaipanScope : LifetimeScope
    {
        ...
        public static void RegisterPlayer(IContainerBuilder builder, PlayerParamManager playerParamManager)
        {
            ...
            builder.Register<DaipanExecutorLocal>(Lifetime.Scoped).AsImplementedInterfaces();
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.Register<FinalBossColorChanger>(Lifetime.Scoped).AsImplementedInterfaces();
