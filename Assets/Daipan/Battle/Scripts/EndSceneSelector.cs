...
namespace Daipan.Battle.scripts
{
    public sealed class EndSceneSelector : IDisposable
    {
        ...
        )
        {
            ...
            {
                EndSceneEnum.NoobGamer => playerMono.Hp.Value / playerMono.MaxHp <= endSceneTransitionParam.hpPercentThresholdForNoobGamerEnd,
                EndSceneEnum.Seijo => daipanExecutor.DaipanCount <= endSceneTransitionParam.daipanCountThresholdForSacredLadyEnd,
                EndSceneEnum.ProGamer => counter.MaxComboCount >= endSceneTransitionParam.maxComboCountThresholdForProGamerEnd,
                EndSceneEnum.Enjou => daipanExecutor.DaipanCount >= endSceneTransitionParam.daipanCountThresholdForBacklashEnd,
                EndSceneEnum.Hakononaka => viewerNumber.Number <= endSceneTransitionParam.viewerCountThresholdForInsideTheBoxEnd,
                EndSceneEnum.Kansyasai => viewerNumber.Number >= endSceneTransitionParam.viewerCountThresholdForThanksgivingEnd,
