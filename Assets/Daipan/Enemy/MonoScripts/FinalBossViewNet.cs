...
{
    public sealed class FinalBossViewNet : AbstractFinalBossViewNet 
    {
        ...
        [SerializeField] NetworkMecanimAnimator animatorDamage = null!;
        [SerializeField] NetworkMecanimAnimator animatorDamageLine = null!;
        [SerializeField] NetworkMecanimAnimator animatorGekiha = null!;
        [SerializeField] SpriteRenderer highlightSpriteRenderer = null!;
        NetworkMecanimAnimator _leaderAnimator = null!;
        ...
        public override void Died(System.Action onDied)
        {
            ...
            Observable.EveryValueChanged(_leaderAnimator.Animator, a => a.IsAlmostEnd())
                .Where(isEnd => isEnd)
