...
{
    public sealed class EnemySpecialViewNet : AbstractEnemyViewNet, IEnemySpecialView
    {
        ...
        [SerializeField] NetworkMecanimAnimator animatorSpecialBlackBody = null!;
        [SerializeField] NetworkMecanimAnimator animatorSpecialBlackEye = null!;
